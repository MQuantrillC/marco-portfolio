...
await sleep(5000);
await shot(join(out, 'mob-1-hero.png'));
for (const [name, sel] of [['mob-2-work','#work'],['mob-3-photos','section[aria-label="Photography"]'],['mob-4-about','#about'],['mob-5-reel','#reel'],['mob-6-contact','#contact']]) {
